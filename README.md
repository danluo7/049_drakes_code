...
# MODIFYING THE CODE to make this work for stattest by setting the "type" in the header file:

mkdir -p /home/daniel/ubuntu/workspace/all_049/drakes_data/18-0190-049/de/ballgown/ref_only/stattest
cd /home/daniel/ubuntu/workspace/all_049/drakes_data/18-0190-049/de/ballgown/ref_only/stattest

printf "\"ids\",\"type\",\"path
\
"\n"Sample6_Lane2","tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample6_Lane2
"\n"Sample6_Lane3","tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample6_Lane3
"\n"Sample17_Lane2","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample17_Lane2
"\n"Sample17_Lane3","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample17_Lane3
"\n"Sample18_Lane2","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample18_Lane2
"\n"Sample18_Lane3","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample18_Lane3
"\n"Sample29_Lane2","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample29_Lane2
"\n"Sample29_Lane3","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample29_Lane3
"\n"Sample26_Lane2","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample26_Lane2
"\n"Sample27_Lane2","non-tissue","$gbm_049_drake/expression/stringtie/ref_only/Sample27_Lane2
"\n" > GBM049_all_drake_stattest.csv
...
cat GBM049_all_drake_stattest.csv
...
#R script:
	...
	working_dir = "/home/daniel/ubuntu/workspace/all_049/drakes_data/18-0190-049/de/ballgown/ref_only/stattest"
	setwd(working_dir)
	dir()


	pheno_data = read.csv("GBM049_all_drake_stattest.csv")  
